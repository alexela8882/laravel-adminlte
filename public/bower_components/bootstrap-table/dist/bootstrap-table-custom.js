...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        iconsPrefix: 'fa', // fa of glyphicon (bootstrap default)
        icons: {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            $.each(pageList, function (i, page) {
                if (!that.options.smartDisplay || i === 0 || pageList[i - 1] < that.options.totalRows) {
                    ...
                    pageNumber.push(sprintf('<li role="menuitem"%s><a href="#" class="dropdown-item">%s</a></li>', active, page));
                }
            });
            ...
            html.push('</div>',
                ...
                '<li class="page-pre page-item"><a href="#" class="page-link">' + this.options.paginationPreText + '</a></li>');
            ...
            html.push(
                '<li class="page-next page-item"><a href="#" class="page-link">' + this.options.paginationNextText + '</a></li>',
                '</ul>',
                '</div>');
        }
