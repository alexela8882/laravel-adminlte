    ...
    <div class="row mt-4 mb-4">
      <div class="col-md-12">
        <div class="box box-warning">
          ...
          <form id="dl-file-form" method="post" action="{{ route('file.download', ['id' => $file->id]) }}">
						{{ csrf_field() }}
					</form>

          <form method="post"
          			action="{{ route('file.update', ['id' => $file->id]) }}"
		        ...
		        <div class="box-footer">
		        	<div class="row">
		        		<div class="col-md-5">
									...
									<a href="{{ route('files.index') }}" class="btn btn-default pull-right">Back</a>
								</div>
							</div>
						</div>
		      </form>
...
<script>
	...
	var url = '{{ route("file.edit-ajax", ["id" => ":id"]) }}',
  		fileId = '{{ $file->id }}',
